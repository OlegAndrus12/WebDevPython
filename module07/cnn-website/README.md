...
A news reader on [newsapi.org](https://newsapi.org/), async end to end: FastAPI
routes, `AsyncSession`, `httpx.AsyncClient`, an async Alembic `env.py`, and
Postgres in Compose. Generated API docs at `/docs`.
