"""Interface Segregation — AFTER: the wide interface is split into one small role per capability,
so each class declares only the roles it can actually fulfil."""
